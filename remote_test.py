...
from remote.plc import poller, poller_simulator, PlcOffline
from remote.io	import motor
from serial_test import start_modbus_simulator
...
def simulated_modbus_tcp():
    ...
    return start_modbus_simulator( options=[
        '-vvv', '--log', 'remote_test.modbus_sim.log.localhost:11502',
        '--evil', 'delay:.25', 
